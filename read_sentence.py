...
O (Lasso): Smooth ARCH at TOP. BOTTOM has KNOT with lines CROSSING making figure-8 or pretzel. Bottom is MESSY TANGLED. CRITICAL: bottom ends CROSS and TANGLE not clean and open.
...
S (Bolt): Looks like lowercase letter n. Smooth arch at top. TWO CLEAN OPEN LEGS at bottom. CRITICAL: bottom is OPEN and FREE like letter n. COMPLETELY DIFFERENT from O which has tangled crossed bottom.
